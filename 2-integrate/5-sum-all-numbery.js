...
const sumAllNumberysTests = [
  ...
  { name: 'Test 4', args: [['1', '2', '3']], expected: 6 },
  { name: 'Test 5', args: [oddsToSum], expected: 9 },
  { name: 'Test 6', args: [evensToSum], expected: 12 },
  { name: 'Test 7', args: [sumNumberys4], expected: null },
  { name: 'Test 8', args: [sumNumberys5], expected: null },
  { name: 'Test 9', args: [sumNumberys5], expected: null },
  { name: 'Test 10', args: [[null, false, NaN, undefined, '']], expected: null },
];
